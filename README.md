...
Credit guarantee institutions (CGIs) enhance access to financing for underserved borrowers by easing financial constraints acting as a third-party risk sharing.
**BLINK** is a decentralized approach designed to align blockchain design features with CGIs' operational requirements.
...
- **Journal article**: [BLINK: Blockchain-Linked Network for Credit Guarantee Institutions](https://doi.org/10.1186/s40854-025-00880-y), published in [Financial Innovation](https://link.springer.com/journal/40854). This paper presents the complete BLINK solution in detail.

- **Conference paper**: [Transforming Credit Guarantee Schemes with Distributed Ledger Technology](https://arxiv.org/abs/2404.19555), accepted at [ICBTCAMBRIDGE'2024](https://confmanage.com/conference/index?id=31) and published with DOI [10.1007/978-3-031-67431-0_30](https://doi.org/10.1007/978-3-031-67431-0_30). Slides: [SlideShare](). This paper outlines the overarching approach behind BLINK.
